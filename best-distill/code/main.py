...
def parse_args_and_config():
    ...
    parser.add_argument('--config', type=str, default='/opt/data/private/mcvd-pytorch2/mcvd-pytorch/configs/TCG.yml',required=False, help='Path to the config file')
    ...
    parser.add_argument('--exp', type=str, default='/opt/data/private/mcvd-pytorch2/mcvd-pytorch/lx-8-11-distill-encoder-last', required=False, help='Path for saving running related data.')
    ...
    parser.add_argument('--ckpt', type=int, default=95000, help='Model checkpoint # to load from, when using sample/video_gen/test/fast_fid')
