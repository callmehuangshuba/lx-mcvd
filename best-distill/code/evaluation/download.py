...
import torch
import warnings
default_pretrained_metrics_dir = '/opt/data/private/earth-forecasting-transformer/pretrained/metrics'
...
def download_pretrained_weights(ckpt_name, save_dir=None, exist_ok=False):
    ...
    """
    if save_dir is None:
        save_dir = '/opt/data/private/earth-forecasting-transformer/pretrained'
