...
@torch.no_grad()
def ddpm_sampler(x_mod, scorenet, cond=None,cond_era5=None,cond_era5_3d=None,attn=None, just_beta=False, final_only=False, denoise=True, subsample_steps=None,
    ...
    images = []
    scorenet = partial(scorenet, cond=cond,era5_cond=cond_era5,era5_cond_3d=cond_era5_3d,attn=attn)
    x_transf = False
...
def anneal_Langevin_dynamics_interpolation(x_mod, scorenet, n_interpolations, n_steps_each=200, step_lr=0.000008,
                             final_only=False, verbose=False, log=False, cond=None,attn=None, **kwargs):
    sigmas = scorenet.module.sigmas if hasattr(scorenet, 'module') else scorenet.sigmas
    ...
    scorenet = partial(scorenet, cond=cond,attn=attn)
