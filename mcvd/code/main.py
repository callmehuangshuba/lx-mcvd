...
def parse_args_and_config():
    ...
    parser.add_argument('--data_path', type=str, default='/root/WP', required=False, help='Path to the dataset')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed')
    parser.add_argument('--exp', type=str, default='/opt/data/private/mcvd-pytorch2/mcvd-pytorch/grad_test_3', required=False, help='Path for saving running related data.')
    ...
    parser.add_argument('--ckpt', type=int, default=1000, help='Model checkpoint # to load from, when using sample/video_gen/test/fast_fid')
