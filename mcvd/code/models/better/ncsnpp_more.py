...
from models.better.lx_visuals import visualize_topk_indices,visualize_topk_attn_channels
...
def visualize_and_save_era5_variables(sst, msl, z, r, save_dir="/opt/data/private/mcvd-pytorch2/mcvd-pytorch/lx_2d+3d_era5_attn_visual/!!!!!!!.png"):
    os.makedirs(save_dir, exist_ok=True)

    def plot_4ch(tensor, var_name):
        """
