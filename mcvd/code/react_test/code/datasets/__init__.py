...
def                          get_dataset(data_path, config, video_frames_pred=0, start_at=0):
    ...
    #                                step_length=config.data.step_length, with_target=True)
        ...
        # dataset = TCGVideoDataset(time_resolution=3,data_dir=data_path,type='TC_img_npy/TCG_test_traj-3',type2="era5_dataset_npy_84/2D/test",type3="era5_dataset_npy_84/3D/test",num_frames=9)
        # test_dataset = TCGVideoDataset(time_resolution=3,data_dir=data_path,type='TC_img_npy/TCG_test_traj-3',type2="era5_dataset_npy_84/2D/test",type3="era5_dataset_npy_84/3D/test",num_frames=9)   
