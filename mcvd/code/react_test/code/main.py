...
def parse_args_and_config():
    ...
    parser.add_argument('--exp', type=str, default='/opt/data/private/mcvd-pytorch2/mcvd-pytorch/react_test', required=False, help='Path for saving running related data.')
    ...
    parser.add_argument('--ckpt', type=int, default=75000, help='Model checkpoint # to load from, when using sample/video_gen/test/fast_fid')
