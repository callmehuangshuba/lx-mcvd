...
# 可视化topk的特征图 图
def visualize_topk_attn_channels(attn_feat, indices, save_path="/opt/data/private/mcvd-pytorch3/mcvd-pytorch/channels_visual/channels_visual_topk-8-20", sample_idx=0, var_name='h', topk=30):
    """
...
def visualize_topk_channel_diff(before_feat, after_feat, indices, sample_idx=0, var_name="diff", save_path="/opt/data/private/mcvd-pytorch3/mcvd-pytorch/channels_visual/aug_diff", topk=10):
    """
...
# 放大aug 增强前后特征图对比
def visualize_aug_diff_triplet(before_feat, after_feat, indices, sample_idx=0, topk=10, var_name="feat", save_path="/opt/data/private/mcvd-pytorch3/mcvd-pytorch/channels_visual/aug_diff_3-8-20"):
    """
...
# 可视化topk通道
def visualize_topk_indices(indices_dict, topk=30, save_path="/opt/data/private/mcvd-pytorch3/mcvd-pytorch/channels_visual/channels_visual_topk_num-104000.png"):
    """
