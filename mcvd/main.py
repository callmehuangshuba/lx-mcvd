...
def parse_args_and_config():
    ...
    parser.add_argument('--config', type=str, default='/opt/data/private/mcvd-pytorch3/mcvd-pytorch/configs/TCG.yml',required=False, help='Path to the config file')
    parser.add_argument('--data_path', type=str, default='/opt/data/private/datasets', required=False, help='Path to the dataset')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed')
    parser.add_argument('--exp', type=str, default='/opt/data/private/mcvd-pytorch3/mcvd-pytorch/grad_test_3_mask_ste_new-aug', required=False, help='Path for saving running related data.')
    ...
    parser.add_argument('-i', '--image_folder', type=str, default='images-90000-lx', help="The folder name of samples")
    ...
    parser.add_argument('--ckpt', type=int, default=100000, help='Model checkpoint # to load from, when using sample/video_gen/test/fast_fid')
